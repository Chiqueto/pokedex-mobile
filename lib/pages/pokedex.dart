      ...
      body: filteredPokemonList.isEmpty
          ...
          : GridView.builder(
              ...
              gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                crossAxisCount: 2,
                childAspectRatio:
                    1.2, // Pode ajustar para 1.0 ou 1.5 conforme preferir
                crossAxisSpacing: 8,
                mainAxisSpacing: 8, // ADICIONE esse campo também!
                mainAxisExtent: 150, // Ajuste aqui para dar altura ao card
              ),
    ...
    return Scaffold(
      ...
      body: FutureBuilder(
          ...
          builder: (context, snapshot) {
            ...
            debugPrint('gifUrl: $gifUrl');
            debugPrint('Nome: ${pokemonData['name']}');
            debugPrint('Altura: ${pokemonData['height']}');
            debugPrint('Peso: ${pokemonData['weight']}');
            return Container(
              color: typeColor,
              child: Center(
